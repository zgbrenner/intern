...
export function Sidebar({ active, items, onChange, onSettings }: { active: QueueView; items: { status: string }[]; onChange(view: QueueView): void; onSettings(trigger: HTMLButtonElement): void }) {
  ...
  return <nav className="sidebar" aria-label="Queue navigation">
