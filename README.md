...
Windows 10 or 11, x86-64. Download `Intern_0.1.0-alpha.8_x64-setup.exe` from the
...
```powershell
./scripts/smoke-installer.ps1 -InstallerPath target/release/bundle/nsis/Intern_0.1.0-alpha.8_x64-setup.exe
```
