...
if (manifest.distribution) {
  ...
  const workflowMatch = /^Release v(0\.1\.0-alpha\.9)$/.exec(manifest.subject.workflow);
  requireValue(workflowMatch, 'release evidence workflow must be exactly Release v0.1.0-alpha.9');
