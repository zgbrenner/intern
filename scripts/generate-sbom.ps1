...
try {
    ...
    foreach ($Package in $Packages) {
        ...
        $Published = Join-Path $Release "Intern-v0.1.0-alpha.7-runtime-$SafeName.spdx.json"
    ...
    $MainManifest = Invoke-SbomGenerate -Drop $Release -Components $RepositoryRoot -Name "Intern" -Version "0.1.0-alpha.7" -ExternalList $ExternalList
    ...
    Copy-Item -LiteralPath $MainManifest -Destination (Join-Path $Release "Intern-v0.1.0-alpha.7.spdx.json")
